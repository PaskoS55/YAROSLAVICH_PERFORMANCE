...
const sections: NavSection[] = [
  {
    title: null,
    items: [
      { href: '/', label: 'Главная', icon: ic(<><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></>) },
    ],
  },
  {
    title: 'Игроки',
    items: [
      ...
      { href: '/team', label: 'Команда', icon: ic(<><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></>) },
  ...
  },
  {
    title: 'Тестирования',
    items: [
      { href: '/sessions', label: 'Журнал сессий', icon: ic(<><rect width="18" height="18" x="3" y="4" rx="2" /><line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /></>) },
      { href: '/testing/team', label: 'Командный ввод', icon: ic(<><rect x="8" y="2" width="8" height="4" rx="1" /><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><path d="m9 14 2 2 4-4" /></>) },
    ],
  },
  {
    title: 'Аналитика',
